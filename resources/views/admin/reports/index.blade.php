...
<div class="row g-4">
    <div class="col-md-4">
        <div class="card p-4 text-center h-100" style="border-radius:12px;">
            ...
            <a href="{{ route('admin.reports.participants') }}" class="btn btn-primary btn-sm fw-bold mt-auto">
    ...
    <div class="col-md-4">
        <div class="card p-4 text-center h-100" style="border-radius:12px;">
            ...
            <a href="{{ route('admin.reports.transactions') }}" class="btn btn-success btn-sm fw-bold mt-auto">
                <i class="bi bi-eye"></i> Lihat Laporan
            </a>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card p-4 text-center h-100" style="border-radius:12px;">
            ...
            <a href="{{ route('admin.reports.attendance') }}" class="btn btn-warning btn-sm text-dark fw-bold mt-auto">
                <i class="bi bi-eye"></i> Lihat Laporan
            </a>
        </div>
    </div>
