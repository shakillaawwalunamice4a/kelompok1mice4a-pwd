                ...
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('password.request') }}" class="small text-decoration-none" style="color:var(--primary);">Lupa password?</a>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <p class="text-muted small mb-0">Belum punya akun?
                            <a href="{{ route('register') }}" class="fw-bold text-decoration-none" style="color:var(--primary);">Daftar Sekarang</a>
                        </p>
                    </div>
                </div>
            </div>
