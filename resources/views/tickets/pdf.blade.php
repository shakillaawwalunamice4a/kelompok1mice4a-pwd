...
<body>
    <div class="ticket">
        <div class="header">
            ...
            <p style="margin:5px 0 0;opacity:0.8;">{{ $ticket->kode_tiket }}</p>
        </div>
        ...
        <div class="details">
            <table>
                <tr><td>Event</td><td>{{ $ticket->event->nama_event }}</td></tr>
                <tr><td>Tanggal</td><td>{{ $ticket->event->tanggal->format('d F Y') }}</td></tr>
                <tr><td>Waktu</td><td>{{ $ticket->event->waktu ?? '-' }}</td></tr>
                <tr><td>Lokasi</td><td>{{ $ticket->event->lokasi }}</td></tr>
                <tr><td>Peserta</td><td>{{ $ticket->user->name }}</td></tr>
