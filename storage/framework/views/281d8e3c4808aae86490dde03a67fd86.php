...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - MeeTopia Admin</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-white text-decoration-none">Mee<span>Topia</span></a>
        </div>
        <div class="sidebar-menu">
            ...
            <a href="<?php echo e(route('admin.transactions.index')); ?>" class="<?php echo e(request()->routeIs('admin.transactions.*') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            ...
            <div class="d-flex align-items-center">
                <span class="me-3 text-muted small"><?php echo e(now()->format('d M Y')); ?></span>
                <div class="dropdown">
                    <a href="#" class="text-decoration-none d-flex align-items-center" data-bs-toggle="dropdown">
                        ...
                        <span class="ms-2 fw-medium"><?php echo e(auth()->user()->name); ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text small text-muted"><?php echo e(auth()->user()->email); ?></span></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('home')); ?>"><i class="bi bi-globe"></i> View Site</a></li>
                        <li>
...
<?php /**PATH C:\xampp\htdocs\MeeTopia\resources\views/layouts/admin.blade.php ENDPATH**/ ?>