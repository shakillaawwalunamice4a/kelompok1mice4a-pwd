...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MeeTopia'); ?> - MeeTopia</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">Mee<span>Topia</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('events*') ? 'active' : ''); ?>" href="<?php echo e(route('events.index')); ?>">Events</a>
                    </li>
                    <?php if(auth()->guard()->check()): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('bookings*') ? 'active' : ''); ?>" href="<?php echo e(route('bookings.index')); ?>">My Bookings</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('my-tickets*') || request()->is('tickets*') ? 'active' : ''); ?>" href="<?php echo e(route('tickets.index')); ?>">My Tickets</a>
                    </li>
                    <?php endif; ?>
                </ul>
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-warning btn-sm text-dark fw-bold" href="<?php echo e(route('register')); ?>">Register</a>
                    </li>
                    <?php endif; ?>
                    <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isAdmin()): ?>
                    <li class="nav-item me-2">
                        <a class="btn btn-warning btn-sm text-dark fw-bold" href="<?php echo e(route('admin.dashboard')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo e(route('bookings.index')); ?>"><i class="bi bi-bookmark"></i> My Bookings</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('tickets.index')); ?>"><i class="bi bi-ticket-perforated"></i> My Tickets</a></li>
    ...
    <footer class="footer mt-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <ul class="list-unstyled small">
                        <li class="mb-2"><a href="<?php echo e(route('events.index')); ?>">Browse Events</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('home')); ?>">About Us</a></li>
            ...
            <p class="text-center small mb-0">&copy; <?php echo e(date('Y')); ?> MeeTopia. All rights reserved.</p>
        </div>
    </footer>
...
<?php /**PATH C:\xampp\htdocs\MeeTopia\resources\views/layouts/app.blade.php ENDPATH**/ ?>