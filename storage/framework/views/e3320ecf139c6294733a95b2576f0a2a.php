        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex gap-3">
                    <a href="<?php echo e(route('events.index')); ?>" class="btn btn-warning btn-lg fw-bold text-dark px-4">
...
<section class="py-5" style="background:var(--gray-100);">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('events.index')); ?>" class="btn btn-outline-primary btn-sm fw-bold">
            ...
            <div class="col-md-4">
                <div class="card event-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small mb-2">
                            <i class="bi bi-geo-alt"></i> <?php echo e(Str::limit($event->lokasi, 30)); ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <div class="card event-card h-100">
                    ...
                    <?php endif; ?>
                    <div class="card-body">
                        <h6 class="fw-bold"><?php echo e(Str::limit($event->nama_event, 30)); ?></h6>
                        <p class="text-muted small mb-1"><i class="bi bi-calendar3"></i> <?php echo e($event->tanggal->format('d M Y')); ?></p>
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            <span class="price-tag small">
                                <?php if($event->harga == 0): ?> GRATIS <?php else: ?> Rp <?php echo e(number_format($event->harga, 0, ',', '.')); ?> <?php endif; ?>
                            </span>
                            <small class="text-muted"><?php echo e($event->tiket_terjual); ?> terjual</small>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MeeTopia\resources\views/home.blade.php ENDPATH**/ ?>